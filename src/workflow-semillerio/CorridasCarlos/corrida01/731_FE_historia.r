...
PARAM  <- list()
PARAM$experimento <- "FE7310-01"

PARAM$exp_input  <- "DR7210-01"
...
PARAM$RandomForest$semilla  <- 257401    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 256019   # cambiar por la propia semilla
